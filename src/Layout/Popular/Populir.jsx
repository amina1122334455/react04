...
import Images from '../../assets/populir/image 40.svg'
import Images1 from '../../assets/populir/image 39.svg'
import Images2 from '../../assets/populir/image 38.svg'
import Images3 from '../../assets/populir/image 37.svg'

const Popular = () => {
  return (
    <div className='populir'>
        <div className="container">
            <h2 className='populir__title'>Популярное</h2>
            <div className="populir__component">
                <div className="populir__left">
                    <svg width="90" height="90" viewBox="0 0 90 90" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="45" cy="45" r="45" fill="white"/>
                        <path d="M53 26L37 45.5L53 65" stroke="#254A5A"/>
                    </svg>
                </div>
                <div className="populir__component-product">
                    <img src={Images} alt="" />
                    <h2 className='populir__component-title'>REPlay</h2>
                    <p className='populir__component-p'> Classic shoes</p>
                    <span   className='populir__component-price'>6100 UAH</span>
                    <span className='populir__component-span'>3800 UAH</span>
                </div>
                <div className="populir__component-product">
                    <img src={Images1} alt="" />
                    <h2 className='populir__component-title'>REPlay</h2>
            ...
            <div className='allegory'>
                <div className='allegory__lins'></div>
                <div className='allegory__wrapper'>
                    <svg className='allegory__logo' width="115" height="14" viewBox="0 0 115 14" fill="none" xmlns="http://www.w3.org/2000/svg">
